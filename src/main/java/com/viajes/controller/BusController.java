...
public class BusController {
	...
	public String listadoBuses(Model model) {
		model.addAttribute("mensaje", "Bienvenido al modulo Buses");
	...
	//GET = listar, buscar por codigo y eliminar
	//POST = registrar y actualizar
	
	//Metodo Registrar Bus
	...
	//Metodo para buscar Bus por código
	@GetMapping("/buscar/{id}")
	//-------------- Buscar info sobre ResponseBody y PathVariable
	@ResponseBody
